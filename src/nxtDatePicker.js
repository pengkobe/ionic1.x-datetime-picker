(function () {
    var module = angular.module('nxt-date-picker-cmp', ['proton.multi-list-picker']);
    module.directive('nxtDatePicker', ["$parse", function ($parse) {
        ...
        return {
            restrict: "E",
            replace: true,
            templateUrl: "../src/nxtDatePicker.html",
            //require: "?ngModel",
            // scope: {
            //     done: "&?"
            // },
